...
export const projects = [
  {
    ...
    documentation: [
      { title: "Attendance records", image: "/kosflow_monitoringkamera.png" },
  ...
  },
  {
    ...
    documentation: [
      ...
      { title: "Detection process", image: "/result_facerecognition.png" },
    ],
    keyFeatures: [
  ...
  },
  {
    ...
    documentation: [
      { title: "Timeline Pesantren", image: "/timeline_pesantren.png" },
      { title: "Home Pesantren", image: "/home_pesantren.png" },
      { title: "Login", image: "/login_pesantren.png" },
    ],
    keyFeatures: [
  ...
  },
  {
    ...
    documentation: [
      { title: "Company website", image: "/mitrajasapower_home.png" },
      { title: "Admin dashboard", image: "/mitrajasapower_dashboard.png"},
      { title: "Login", image: "/mitrajasapower_login.png" },
    ],
    keyFeatures: [
  ...
  },
  {
    ...
    documentation: [
      ...
      { title: "Mobile product listing", image: "/iquarium_home.png" },
      { title: "Dashboard", image: "/iquarium_dashboard.png" },
    ],
    keyFeatures: [
  ...
  },
  {
    ...
    documentation: [
      { title: "Live interface", image: "/home_satebeber.png" },
      { title: "Dashboard page", image: "/dashboard_satebeber.png" },
      { title: "Login", image: "/login_satebeber.png" },
    ],
    keyFeatures: [
  ...
  },
  {
    ...
    documentation: [
      ...
      { title: "Product Menu", image: "/manika_menu.png"},
      { title: "About Manika", image: "/manika_about.png" },
    ],
    keyFeatures: [
